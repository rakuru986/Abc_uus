...
namespace Abc.Tests {
    ...
    public class BaseTests {
        ...
        [TestMethod] public void IsSpecifiedClassTested() {
            if (type == null) Assert.Inconclusive(notSpecified);
            var typeName = type.Name;
            var index = typeName.IndexOf("`", StringComparison.Ordinal);
            if (index > -1) typeName = typeName.Substring(0, index);
        ...
        protected static void arePropertiesEqual(object obj1, object obj2)
        {
