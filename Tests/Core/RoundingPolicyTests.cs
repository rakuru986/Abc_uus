...
namespace Abc.Tests.Core {
    ...
    [TestClass] public class RoundingPolicyTests : SealedClassTests<RoundingPolicy, object> {
        ...
        [TestMethod] public void IsRoundByStepTest() {
        ...
        [TestMethod] public void RoundingPolicyDefaultTest() {
        ...
        [TestMethod] public void RoundingPolicyRoundingStepTest() {
        ...
        [TestMethod] public void RoundingPolicyNumberOfDigitsTest() {
        ...
        [TestMethod] public void RoundingPolicyRoundingDigitTest() {
        ...
        [TestMethod] public void InternalRoundTest() {
            Assert.AreEqual(4.5, new RoundingPolicy(RoundingStrategy.Round, 1, 5).round(4.45));
            Assert.AreEqual(4.45, new RoundingPolicy(RoundingStrategy.Round, 2, 7).round(4.456));
            Assert.AreEqual(-4.5, new RoundingPolicy(RoundingStrategy.Round, 1, 5).round(-4.45));
            Assert.AreEqual(-4.45, new RoundingPolicy(RoundingStrategy.Round, 2, 7).round(-4.456));
